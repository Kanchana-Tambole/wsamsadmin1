...
public class FeesCategoryDto {
    ...
    // Constructor using UserProfile entities
    public FeesCategoryDto(long id, String name, String description, boolean status,
    ...
    // Constructor using UserProfileDtoList directly
    public FeesCategoryDto(long id, String name, String description, boolean status,
                           LocalDateTime createdAt, LocalDateTime updatedAt,
